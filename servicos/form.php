                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input readonly type="text" class="form-control" id="pk_servico" name="pk_servico" value="<?php echo
                                                $pk_servico; ?>">
                                            </div>
                                            <div class="col">
                                                <label for="servico" class="form-label">Serviço</label>
                                                <input required type="text" class="form-control" id="servico" name="servico" value="<?php echo
                                                $servico; ?>">
                                            </div>
                                        </div>
                                    </div>
